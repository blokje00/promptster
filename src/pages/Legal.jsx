                ...
                <ScrollArea className="h-[600px] pr-4">
                  <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
                    <div className="border-l-4 border-slate-300 dark:border-slate-600 p-4 rounded-r">
                      ...
                      <p className="text-sm text-slate-700 dark:text-slate-300">By creating an account, subscribing, or using the Service, you agree to these Terms of Service. The Service is owned and operated by {companyName} ("we", "us", "our").</p>
                    </div>
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">2. Eligibility</h3>
                      <p className="text-slate-700 dark:text-slate-300">You must be at least <strong>16 years old</strong> or the legal age in your jurisdiction to use the Service.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">3. Subscriptions & Billing</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">4. User Responsibilities</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-2">Users agree <strong>not to</strong>:</p>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div className="border-l-4 border-slate-300 dark:border-slate-600 p-4 rounded-r">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">5. Our Right to Suspend or Terminate Accounts</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-2">Promptster reserves the right to suspend or terminate any account at any time if:</p>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                      ...
                      <p className="text-slate-900 dark:text-slate-100 font-medium mt-3">In such cases, we may immediately deactivate the account without refund.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">6. Intellectual Property</h3>
                      <p className="text-slate-700 dark:text-slate-300 leading-relaxed">All platform code, algorithms, and design elements are owned by Promptster.</p>
                      <p className="text-slate-700 dark:text-slate-300 font-medium mt-2">✓ Users retain ownership of the prompts they create.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">7. AI Provider Interaction</h3>
                      <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-3">Promptster may transmit user text or images to third-party AI providers to generate results.</p>
                      <p className="text-slate-700 dark:text-slate-300 font-medium">⚠ We offer no guarantee regarding output accuracy, safety, or legality.</p>
                      <p className="text-slate-600 dark:text-slate-400 mt-2">Users remain responsible for reviewing all AI-generated content.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">8. Limitation of Liability</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-2">To the maximum extent permitted by law:</p>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">9. Termination by User</h3>
                      <p className="text-slate-700 dark:text-slate-300">Users may cancel their subscription at any time through the billing portal. Cancellation halts future billing.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">10. Governing Law</h3>
                      <p className="text-slate-700 dark:text-slate-300">These Terms are governed by the laws of the <strong>Netherlands</strong>, unless otherwise required by local consumer laws.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">11. Changes to Terms</h3>
                      <p className="text-slate-700 dark:text-slate-300">We may update these Terms at any time. Continued use after changes implies acceptance.</p>
                    </div>
                  </div>
                </ScrollArea>
              </CardContent>
              ...
              <CardContent>
                <ScrollArea className="h-[600px] pr-4">
                  <div className="prose prose-slate max-w-none space-y-6">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">1. Data We Collect</h3>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">2. Legal Basis for Processing (GDPR)</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-2">We process data under:</p>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">3. How We Use Your Data</h3>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">4. Subprocessors</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-3">We use the following trusted service providers:</p>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">5. International Transfers</h3>
                      <p className="text-slate-700 dark:text-slate-300">Data may be transferred outside the EU using <strong>Standard Contractual Clauses (SCCs)</strong> to ensure adequate protection.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">6. Data Retention</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-2">We keep data only as long as needed for:</p>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                        <li>• Contract performance</li>
                        <li>• Legal obligations</li>
                        <li>• User support</li>
                      </ul>
                      <p className="text-slate-700 dark:text-slate-300 font-medium mt-3">✓ Users may request deletion at any time.</p>
                    </div>
                    
                    <div className="border-l-4 border-slate-300 dark:border-slate-600 p-4 rounded-r">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">7. Your GDPR Rights</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-2">Under GDPR you may:</p>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                      ...
                      <p className="text-slate-900 dark:text-slate-100 font-medium mt-3">📧 Contact: {supportEmail}</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">8. Security</h3>
                      <p className="text-slate-700 dark:text-slate-300">We use modern security practices including encryption, access controls, and monitoring.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">9. Children</h3>
                      <p className="text-slate-700 dark:text-slate-300">We do <strong>not knowingly</strong> collect data from children under 16.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">10. Updates</h3>
                      <p className="text-slate-700 dark:text-slate-300">We may update this Privacy Policy at any time. Continued use implies acceptance.</p>
                    </div>
                  </div>
                </ScrollArea>
              </CardContent>
                ...
                <ScrollArea className="h-[600px] pr-4">
                  <div className="prose prose-slate max-w-none space-y-6">
                    <div>
                      ...
                      <p className="text-slate-700 dark:text-slate-300">Cookies are small text files stored on your device when you visit our website. They help us provide essential functionality and improve your experience.</p>
                    </div>
                    
                    <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">Types of Cookies We Use</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">Managing Cookies</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-2">You can control cookies through your browser settings.</p>
                      <p className="text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 p-3 rounded text-sm">⚠ Note: Disabling essential cookies may impact functionality.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">Third-Party Cookies</h3>
                      <p className="text-slate-700 dark:text-slate-300">Some features may use third-party cookies from services like <strong>Stripe</strong> for payment processing.</p>
                    </div>
                  </div>
                </ScrollArea>
              </CardContent>
              ...
              <CardContent>
                <ScrollArea className="h-[600px] pr-4">
                  <div className="prose prose-slate max-w-none space-y-6">
                    ...
                    <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">⚠ Consequences</h3>
                      <p className="text-slate-700 dark:text-slate-300">We may <strong>suspend or terminate</strong> accounts violating this policy without prior notice or refund.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">Reporting Violations</h3>
                      <p className="text-slate-700 dark:text-slate-300">If you observe policy violations, please report them to:</p>
                      <p className="text-slate-700 dark:text-slate-300 font-medium mt-2">📧 {supportEmail}</p>
                    </div>
                  </div>
                </ScrollArea>
              </CardContent>
              ...
              <CardContent>
                <ScrollArea className="h-[600px] pr-4">
                  <div className="prose prose-slate max-w-none space-y-6">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">Cancellation</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-2">Users can cancel at any time via the billing portal or subscription settings.</p>
                      <p className="text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 p-3 rounded text-sm">⚠ Cancellation stops future billing but does not refund past charges.</p>
                    </div>
                    
                    <div className="border-l-4 border-slate-300 dark:border-slate-600 p-4 rounded-r">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">Refund Policy</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-2">Refunds are granted only when required by law.</p>
                      <p className="text-slate-700 dark:text-slate-300">For example: EU customers have a <strong>14-day right of withdrawal</strong> for digital services under consumer protection rules.</p>
                      <p className="text-sm text-slate-600 dark:text-slate-400 mt-3">Refund requests must be submitted within 14 days of purchase for EU customers.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">Failed Payments</h3>
                      <p className="text-slate-700 dark:text-slate-300">Failed payments may lead to suspension of access. We will attempt to contact you before suspension.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">Plan Changes</h3>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">Contact</h3>
                      <p className="text-slate-700 dark:text-slate-300">For billing inquiries:</p>
                      <p className="text-slate-700 dark:text-slate-300 font-medium mt-2">📧 {supportEmail}</p>
                    </div>
                  </div>
                </ScrollArea>
                ...
                <ScrollArea className="h-[600px] pr-4">
                  <div className="prose prose-slate max-w-none space-y-6">
                    <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                      ...
                      <p className="text-slate-700 dark:text-slate-300">Promptster uses external AI providers (<strong>OpenAI, Anthropic, Google</strong>) to generate output and assist with features.</p>
                    </div>
                    
                    <div className="border-l-4 border-slate-300 dark:border-slate-600 p-4 rounded-r">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">⚠ No Guarantees</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-2">We <strong>cannot guarantee</strong> that:</p>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">Limitation of Liability</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-2">Promptster is <strong>not liable</strong> for damages arising from the use of AI-generated content, including but not limited to:</p>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">🔒 Data Processing</h3>
                      <p className="text-slate-700 dark:text-slate-300">When you use AI features, your prompts and uploaded content may be sent to third-party AI providers.</p>
                      <p className="text-slate-700 dark:text-slate-300 font-medium mt-2">See our Privacy Policy for details.</p>
                    </div>
                  </div>
                </ScrollArea>
              </CardContent>
              ...
              <CardContent>
                <ScrollArea className="h-[600px] pr-4">
                  <div className="prose prose-slate max-w-none space-y-6">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">👥 Organizational Measures</h3>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">🏗️ Infrastructure</h3>
                      <p className="text-slate-700 dark:text-slate-300">Our infrastructure is hosted on <strong>Base44</strong> and <strong>Supabase</strong>, which maintain <strong>SOC 2 Type II compliance</strong> and follow industry best practices.</p>
                    </div>
                    
                    <div className="border-l-4 border-slate-300 dark:border-slate-600 p-4 rounded-r">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">🚨 Reporting Security Issues</h3>
                      <p className="text-slate-700 dark:text-slate-300 mb-2">If you discover a security vulnerability, please report it immediately to:</p>
                      <p className="text-slate-900 dark:text-slate-100 font-bold mt-2">📧 {supportEmail}</p>
                      <p className="text-slate-600 dark:text-slate-400 text-sm mt-3">We appreciate responsible disclosure and will respond within <strong>48 hours</strong>.</p>
                    </div>
                  </div>
                </ScrollArea>
              </CardContent>
                ...
                <ScrollArea className="h-[600px] pr-4">
                  <div className="prose prose-slate max-w-none space-y-6">
                    <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                      ...
                      <p className="text-slate-700 dark:text-slate-300"><strong>Email:</strong> {supportEmail}</p>
                      <p className="text-slate-700 dark:text-slate-300"><strong>Company:</strong> {companyName}</p>
                    </div>
                    
                    <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">⏱️ Support Response Times</h3>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">✓ What We Can Help With</h3>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">🛠️ Self-Service Resources</h3>
                      <ul className="space-y-2 text-slate-700 dark:text-slate-300">
                    ...
                    <div className="border-l-4 border-slate-300 dark:border-slate-600 p-4 rounded-r">
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">💬 Complaints</h3>
                      <p className="text-slate-700 dark:text-slate-300">If you have a complaint, please email us at <strong>{supportEmail}</strong>.</p>
                      <p className="text-slate-600 dark:text-slate-400 text-sm mt-2">We will investigate and respond within <strong>7 business days</strong>.</p>
                    </div>
                    
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">🏛️ Data Protection Authority</h3>
                      <p className="text-slate-700 dark:text-slate-300">For privacy-related complaints, you may also contact your local data protection authority.</p>
                    </div>
                  </div>
                </ScrollArea>
              </CardContent>
