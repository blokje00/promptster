      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <div className="space-y-4 text-lg text-slate-600">
            <p>The first step is easy: type or speak some text, and your app is (almost) there. That part is simple—and cheap!</p>
            <p>But then the real work begins: dozens of small prompts that gradually nudge your no-code platform toward the final result. All the time and cost advantages from that "easy first step" evaporate again: time-consuming, frustrating, and burning through credits.</p>
          ...
          <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-xl p-6 border border-purple-200 dark:border-purple-800">
            ...
            <ul className="space-y-2 text-sm text-slate-700 dark:text-slate-300">
              <li className="flex items-start gap-2">
                ...
                <span>Recognizes buttons, inputs, cards, modals, tabs and more</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-purple-600 dark:text-purple-400 mt-0.5 shrink-0" />
                <span>Understands context: label → input, title → content, parent → child</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-purple-600 dark:text-purple-400 mt-0.5 shrink-0" />
                <span>Automatically builds a visual UI structure used for better prompts</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-purple-600 dark:text-purple-400 mt-0.5 shrink-0" />
                <span>Ensures higher accuracy, fewer errors and faster multi-task output</span>
              </li>
            </ul>
          </div>
